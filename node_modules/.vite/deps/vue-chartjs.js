...
import { Fn as isProxy, Ft as onMounted, Kn as ref, Ot as nextTick, Yn as shallowRef, Zn as toRaw, gn as watch, nt as defineComponent, pt as h, zt as onUnmounted } from "./vue.runtime.esm-bundler-BbnC8aGa.js";
//#region node_modules/vue-chartjs/dist/index.js
var CommonProps = {
	data: {
		type: Object,
		required: true
...
var compatProps = "3.5.38"[0] === "2" ? (internals, props) => Object.assign(internals, { attrs: props }) : (internals, props) => Object.assign(internals, props);
...
var Chart = defineComponent({
	...
	setup(props, param) {
		...
		const destroyChart = () => {
			...
			if (chart) if (props.destroyDelay > 0) setTimeout(() => {
				chart.destroy();
				chartRef.value = null;
			}, props.destroyDelay);
			else {
